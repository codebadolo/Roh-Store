...
class Vendor(models.Model):
    shop_cover_image = models.ImageField(upload_to=user_directory_path, default="shop-cover-image.jpg", blank=True,
                                         null=True)
    ...
    identity_type = models.CharField(choices=IDENTITY_TYPE, default="national_id_card", max_length=100, blank=True,
                                     null=True)
    ...
    country = models.ForeignKey("addons.TaxRate", on_delete=models.SET_NULL, null=True, related_name="vendor_country",
                                blank=True)
    ...
    keywords = models.CharField(max_length=1000,
                                help_text="Add keywords related to your shop, this would help buyers locate your shop",
    ...
    def vendor_image(self):
        return mark_safe('  <img src="%s" width="50" height="50" style="object-fit:cover; border-radius: 6px;" />' % (
            self.shop_image.url))
...
class OrderTracker(models.Model):
    order_item = models.ForeignKey('store.CartOrderItem', on_delete=models.CASCADE, blank=True, null=True,
                                   related_name="cartorderitem_tracker")
